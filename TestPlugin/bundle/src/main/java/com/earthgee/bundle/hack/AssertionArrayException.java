...
public class AssertionArrayException extends Exception{
    ...
    public void addException(Hack.HackDeclaration.HackAssertionException
        ...
        for(Hack.HackDeclaration.HackAssertionException hackAssertionException:this.mAssertionErr){
            ...
            try{
                if(hackAssertionException.getCause() instanceof NoSuchFieldException){
                    ...
                    stringBuilder.append(hackAssertionException.getHackedClass().getName()).
                            append(".").append(hackAssertionException.getHackedFieldName()).append(Framework.SYMBOL_SEMICOLON);
                    ...
                    stringBuilder.append(hackAssertionException.getHackedClass().getName())
                            .append("->").append(hackAssertionException.getHackedMethodName()).append(Framework.SYMBOL_SEMICOLON);
