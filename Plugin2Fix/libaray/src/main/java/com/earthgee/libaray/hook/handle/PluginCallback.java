...
public class PluginCallback implements Handler.Callback{
    ...
    public PluginCallback(Context context,Handler oldHandle,Handler.Callback callback){
        ...
        try{
            ...
            if(PluginProcessManager.isPluginProcess(mHostContext)){
                if(!PluginManager.getInstance().isConnected()){
                    mOldHandle.sendMessageDelayed(Message.obtain(message),5);
                    return true;
                }
            }
                ...
                if(targetActivityInfo!=null){
                    if(targetComponentName!=null&&targetComponentName.getClassName().startsWith(".")){
                        targetIntent.setClassName(targetComponentName.getPackageName(),
                                targetComponentName.getPackageName()+targetComponentName.getClassName());
                    }
                    ...
                    if(stubActivityInfo!=null){
                        PluginManager.getInstance().reportMyProcessName(stubActivityInfo.processName,
