 ...
 * Original file: C:\\android_wp\\android_plugin\\Plugin2\\library\\src\\main\\aidl\\com\\earthgee\\library\\IPluginManager.aidl
 */
package com.earthgee.library;
public interface IPluginManager extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.earthgee.library.IPluginManager
{
private static final java.lang.String DESCRIPTOR = "com.earthgee.library.IPluginManager";
...
/**
 * Cast an IBinder object into an com.earthgee.library.IPluginManager interface,
 * generating a proxy if needed.
 */
public static com.earthgee.library.IPluginManager asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.earthgee.library.IPluginManager))) {
return ((com.earthgee.library.IPluginManager)iin);
}
return new com.earthgee.library.IPluginManager.Stub.Proxy(obj);
}
...
case TRANSACTION_getInstallPackages:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
java.util.List<android.content.pm.PackageInfo> _result = this.getInstallPackages(_arg0);
reply.writeNoException();
reply.writeTypedList(_result);
return true;
}
...
java.lang.String _arg0;
_arg0 = data.readString();
com.earthgee.library.IPackageDataObserver _arg1;
_arg1 = com.earthgee.library.IPackageDataObserver.Stub.asInterface(data.readStrongBinder());
...
{
data.enforceInterface(DESCRIPTOR);
com.earthgee.library.IApplicationCallback _arg0;
_arg0 = com.earthgee.library.IApplicationCallback.Stub.asInterface(data.readStrongBinder());
...
case TRANSACTION_onActivityDestroy:
{
data.enforceInterface(DESCRIPTOR);
android.content.pm.ActivityInfo _arg0;
if ((0!=data.readInt())) {
...
this.onActivityDestroy(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
case TRANSACTION_onActivityOnNewIntent:
{
data.enforceInterface(DESCRIPTOR);
android.content.pm.ActivityInfo _arg0;
if ((0!=data.readInt())) {
...
this.onActivityOnNewIntent(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
private static class Proxy implements com.earthgee.library.IPluginManager
{
...
@Override public android.content.pm.ResolveInfo resolveIntent(android.content.Intent intent, java.lang.String resolveType, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public java.util.List<android.content.pm.PackageInfo> getInstallPackages(int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(flags);
mRemote.transact(Stub.TRANSACTION_getInstallPackages, _data, _reply, 0);
_reply.readException();
...
@Override public void deleteApplicationCacheFiles(java.lang.String packageName, com.earthgee.library.IPackageDataObserver observer) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void clearApplicationUserData(java.lang.String packageName, com.earthgee.library.IPackageDataObserver observer) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public boolean registerApplicationCallback(com.earthgee.library.IApplicationCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean unregisterApplicationCallback(com.earthgee.library.IApplicationCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public void onActivityDestroy(android.content.pm.ActivityInfo stubInfo, android.content.pm.ActivityInfo targetInfo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_onActivityDestroy, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void onServiceDestroy(android.content.pm.ServiceInfo stubInfo, android.content.pm.ServiceInfo targetInfo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_onServiceDestroy, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void onActivityOnNewIntent(android.content.pm.ActivityInfo stubInfo, android.content.pm.ActivityInfo targetInfo, android.content.Intent intent) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_onActivityOnNewIntent, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getInstallPackages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
...
static final int TRANSACTION_onActivityDestroy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_onServiceCreated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_onServiceDestroy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
...
static final int TRANSACTION_onActivityOnNewIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
...
public android.content.pm.ResolveInfo resolveIntent(android.content.Intent intent, java.lang.String resolveType, int flags) throws android.os.RemoteException;
...
public java.util.List<android.content.pm.PackageInfo> getInstallPackages(int flags) throws android.os.RemoteException;
...
public void deleteApplicationCacheFiles(java.lang.String packageName, com.earthgee.library.IPackageDataObserver observer) throws android.os.RemoteException;
public void clearApplicationUserData(java.lang.String packageName, com.earthgee.library.IPackageDataObserver observer) throws android.os.RemoteException;
...
public boolean registerApplicationCallback(com.earthgee.library.IApplicationCallback callback) throws android.os.RemoteException;
public boolean unregisterApplicationCallback(com.earthgee.library.IApplicationCallback callback) throws android.os.RemoteException;
...
public void onActivityDestroy(android.content.pm.ActivityInfo stubInfo, android.content.pm.ActivityInfo targetInfo) throws android.os.RemoteException;
...
public void onServiceDestroy(android.content.pm.ServiceInfo stubInfo, android.content.pm.ServiceInfo targetInfo) throws android.os.RemoteException;
...
public void onActivityOnNewIntent(android.content.pm.ActivityInfo stubInfo, android.content.pm.ActivityInfo targetInfo, android.content.Intent intent) throws android.os.RemoteException;
